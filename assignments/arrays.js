...
function recall (lookupid, arr) {
  return `car ${lookupid} is a ${arr[lookupid-1].car_year} ${arr[lookupid-1].car_make} ${arr[lookupid-1].car_model}.`;
};

console.log(recall(33, inventory));
...
function last (arr){
  ...
  lastCar = `last car is a ${arr[arr.length-1].car_make} ${arr[arr.length-1].car_model}.`
  return lastCar;
};
console.log(last(inventory));
